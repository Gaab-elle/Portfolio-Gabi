        ...
        >
            ...
            <div className="text-center z-10 px-4">
                ...
                <p className="text-xl md:text-2xl text-gray-300 mb-8">
                    Full Stack Developer • Cybersecurity Entusiasta • Empreendedora
                </p>

                <div className="flex flex-wrap justify-center gap-4 mb-12">
                    <a href="mailto:contato.gabriellerib@gmail.com" className="btn-primary group">
                        <Mail size={20} className="group-hover:scale-110 transition-transform" />
                        <span>Contact Me</span>
                    </a>
                    <a href="https://github.com/Gaab-elle" target="_blank" rel="noopener noreferrer" className="btn-secondary group">
                        <Github size={20} className="group-hover:scale-110 transition-transform" />
                        <span>GitHub</span>
                    </a>
                    <a href="https://linkedin.com/in/gabrielle.ribeiro10" target="_blank" rel="noopener noreferrer" className="btn-secondary group">
